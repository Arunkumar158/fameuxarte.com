...
const NewsLatterBox = () => {
  ...
  return (
    <div className="relative z-10 rounded-sm bg-white p-8 shadow-three dark:bg-gray-dark sm:p-11 lg:p-8 xl:p-11">
      ...
      Join our community and be the first to discover new artworks, artist stories, and exclusive offers. 
      Subscribe now to stay inspired and connected with the world of unseen art!
      </p>
      <div>
        <input
          type="text"
