...
const TermsOfService = () => {
  return (
    <MainLayout>
      <SEO
        title="Terms of Service - Fameuxarte"
        ...
        <div className="max-w-3xl mx-auto space-y-6">
          <section>
            ...
            <p className="text-gray-300">
              By accessing and using Fameuxarte, you agree to be bound by these Terms of Service and all applicable laws and regulations.
            </p>
          </section>
          ...
          <section>
            ...
            <p className="text-gray-300">
              All content on our platform, including artwork, text, graphics, logos, and software, is the property of Fameuxarte or its content suppliers and is protected by international copyright laws.
            </p>
          </section>
          ...
          <section>
            ...
            <p className="text-gray-300">
              Fameuxarte shall not be liable for any indirect, incidental, special, consequential, or punitive damages resulting from your use of or inability to use the service.
            </p>
          </section>
