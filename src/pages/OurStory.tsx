...
const OurStory = () => {
  ...
  return (
    <div className="bg-black min-h-screen text-linen pb-20 overflow-hidden font-sans">
      <SEO 
        title="Our Story | Fameuxarte" 
        description="Fameuxarte began as a dream shared by an artist and a builder who believed creativity deserved a bigger stage."
      />
      <HomeNav />
      ...
      <section className="container pt-12 pb-16 md:pt-20 md:pb-24">
        ...
        >
          ...
          <motion.div variants={fadeIn} className="group relative flex-1">
            ...
            <div className="relative bg-[#0f0f0f] border border-white/[0.08] rounded-3xl p-6 shadow-sm hover:border-white/20 transition-all duration-500 flex flex-col h-full">
              <div className="aspect-[4/5] rounded-2xl overflow-hidden mb-6 relative bg-[#181818]">
                <img 
                  src="/arun.jpg" 
                  alt="Arun Kumar" 
        ...
        >
          ...
          <h2 className="text-2xl md:text-3xl font-light text-stone-300 mb-8">Built from Brushes, Code, and Courage</h2>
      ...
      <section className="container py-16 md:py-24">
        <motion.div 
          ...
          variants={fadeIn}
          className="max-w-3xl mx-auto space-y-8 text-lg md:text-xl leading-relaxed text-stone-300"
        >
          ...
          <div className="bg-[#0f0f0f] rounded-2xl p-8 my-12 border border-white/[0.08] relative overflow-hidden">
      ...
      <section className="bg-[#0a0a0a] py-20 md:py-32 border-y border-white/[0.08]">
        <div className="container">
          ...
          >
            ...
            <div className="grid md:grid-cols-2 gap-12 items-center">
              <motion.div variants={fadeIn} className="space-y-6 text-lg text-stone-300">
                <p>
                ...
                <div className="flex flex-col gap-4 py-6">
                  <div className="flex items-center gap-4 bg-black p-4 rounded-xl border border-white/[0.08]">
                    <div className="w-12 h-12 rounded-full bg-[#181818] text-stone-300 flex items-center justify-center font-serif text-xl">0</div>
              ...
              <motion.div variants={fadeIn} className="relative">
                ...
                <div className="relative bg-[#0f0f0f] border border-white/[0.08] rounded-3xl p-8 overflow-hidden">
      ...
      <section className="container py-20 md:py-32">
        ...
        >
            ...
            <div className="space-y-12 relative">
              ...
              <motion.div variants={fadeIn} className="relative flex flex-col md:flex-row items-center md:justify-between group">
                <div className="md:w-[45%] flex justify-end mb-4 md:mb-0">
                  <div className="bg-[#0f0f0f] border border-white/[0.08] p-6 rounded-2xl w-full relative z-10 group-hover:border-gold/30 transition-colors">
                    ...
                    <p className="text-sm text-stone-400">Endless nights debugging server configurations and deployment pipelines.</p>
                  </div>
                </div>
                <div className="absolute left-1/2 -translate-x-1/2 w-4 h-4 rounded-full bg-black border-2 border-gold z-20 hidden md:block" />
              ...
              <motion.div variants={fadeIn} className="relative flex flex-col md:flex-row items-center md:justify-between group">
                ...
                <div className="md:w-[45%] flex justify-start mb-4 md:mb-0">
                  <div className="bg-[#0f0f0f] border border-white/[0.08] p-6 rounded-2xl w-full relative z-10 group-hover:border-gold/30 transition-colors">
                    ...
                    <p className="text-sm text-stone-400">Navigating international compliance, rejected APIs, and complex transaction flows.</p>
                  </div>
                </div>
              </motion.div>
              ...
              <motion.div variants={fadeIn} className="relative flex flex-col md:flex-row items-center md:justify-between group">
                <div className="md:w-[45%] flex justify-end mb-4 md:mb-0">
                  <div className="bg-[#0f0f0f] border border-white/[0.08] p-6 rounded-2xl w-full relative z-10 group-hover:border-gold/30 transition-colors">
                    ...
                    <p className="text-sm text-stone-400">Optimizing databases and scaling infrastructure to handle high-res artwork.</p>
                  </div>
                </div>
                <div className="absolute left-1/2 -translate-x-1/2 w-4 h-4 rounded-full bg-black border-2 border-gold z-20 hidden md:block" />
                <div className="md:w-[45%] hidden md:block" />
          ...
          <motion.div variants={fadeIn} className="max-w-3xl mx-auto mt-16 text-lg text-stone-300 space-y-6">
            <p>
              ...
              <span className="italic block mt-6 border-l border-white/[0.08] pl-6 text-stone-400">
      ...
      <section className="bg-[#0a0a0a] py-20 md:py-32 relative overflow-hidden border-y border-white/[0.08]">
        ...
        <div className="container relative z-10">
          ...
          >
            ...
            <motion.p variants={fadeIn} className="text-xl md:text-2xl font-light mb-8 text-stone-300 leading-relaxed">
            ...
            <motion.p variants={fadeIn} className="text-lg md:text-xl text-stone-300 mb-12">
      ...
      <section className="container py-20 md:py-32">
        ...
        >
          <motion.div variants={fadeIn} className="text-center mb-16">
            ...
            <p className="text-xl text-stone-300">Innovating the intersection of art and technology.</p>
          </motion.div>
          ...
          <div className="grid md:grid-cols-3 gap-8 max-w-6xl mx-auto">
            ...
            <motion.div variants={fadeIn} className="group relative">
              ...
              <div className="relative bg-[#0f0f0f] border border-white/[0.08] p-8 rounded-3xl transition-all duration-500 h-full flex flex-col items-center text-center hover:border-gold/20">
                <div className="w-16 h-16 rounded-2xl bg-[#161616] border border-white/[0.08] text-verified flex items-center justify-center mb-6 transform group-hover:-translate-y-1 transition-transform duration-500">
                ...
                <p className="text-stone-400 text-sm leading-relaxed">Standing as a shield for traditional creators by using AI to verify whether an artwork is genuinely handmade, digitally reproduced, or machine-generated.</p>
              </div>
            </motion.div>
            ...
            <motion.div variants={fadeIn} className="group relative">
              <div className="absolute inset-0 bg-gradient-to-b from-surface-3 to-transparent rounded-3xl transform transition-transform group-hover:scale-105 duration-500" />
              <div className="relative bg-[#0f0f0f] border border-white/[0.08] p-8 rounded-3xl transition-all duration-500 h-full flex flex-col items-center text-center hover:border-gold/20">
                <div className="w-16 h-16 rounded-2xl bg-[#161616] border border-white/[0.08] text-gold flex items-center justify-center mb-6 transform group-hover:-translate-y-1 transition-transform duration-500">
                ...
                <p className="text-stone-400 text-sm leading-relaxed">Empowering artists to demand what they are worth by translating complex market signals and demand insights into confident pricing strategies.</p>
              </div>
            </motion.div>
            ...
            <motion.div variants={fadeIn} className="group relative">
              <div className="absolute inset-0 bg-gradient-to-b from-surface-3 to-transparent rounded-3xl transform transition-transform group-hover:scale-105 duration-500" />
              <div className="relative bg-[#0f0f0f] border border-white/[0.08] p-8 rounded-3xl transition-all duration-500 h-full flex flex-col items-center text-center hover:border-gold/20">
                <div className="w-16 h-16 rounded-2xl bg-[#161616] border border-white/[0.08] text-stone-300 flex items-center justify-center mb-6 transform group-hover:-translate-y-1 transition-transform duration-500">
                ...
                <p className="text-stone-400 text-sm leading-relaxed">Erasing borders so that a brilliant artist in a remote corner of the world can connect directly with a collector in a bustling metropolis.</p>
              </div>
            </motion.div>
          </div>
        </motion.div>
      ...
      <section className="container py-20 pb-32">
        <motion.div 
          ...
          className="max-w-4xl mx-auto"
        >
          <div className="bg-[#0f0f0f] border border-white/[0.08] rounded-[2rem] p-10 md:p-16 relative overflow-hidden">
            ...
            <div className="relative z-10">
              ...
              <div className="space-y-6 text-lg md:text-xl text-stone-300 font-light mb-12">
                <p>
              ...
              <div className="flex flex-col md:flex-row gap-8 items-center justify-center pt-8 border-t border-white/[0.08]">
                <div className="text-center md:text-right">
                  ...
                  <p className="text-xs text-stone-400 tracking-wide uppercase mt-1">Co-Founder, Fameuxarte</p>
                </div>
                
                <div className="w-px h-16 bg-white/[0.08] hidden md:block" />
