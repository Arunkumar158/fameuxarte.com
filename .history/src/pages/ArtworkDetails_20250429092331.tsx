...
const ArtworkDetails = () => {
  ...
  const artworkDescription = artwork.description 
    ...
    : `${artwork.title} by ${artwork.artist?.name || 'Unknown Artist'}. ${artwork.category || 'Artwork'} for sale.`;
  ...
  return (
    <MainLayout>
      <SEO
        title={`${artwork.title} | ${artwork.artist?.name || 'Unknown Artist'} | Fameuxarte`}
        description={artworkDescription}
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
          ...
          <div className="relative aspect-square rounded-lg overflow-hidden bg-muted">
            <img
              ...
              alt={`${artwork.title} - ${artwork.category || 'Artwork'} by ${artwork.artist?.name || 'Unknown Artist'}`}
          ...
          <div className="space-y-6">
            <div>
              ...
              <p className="text-lg text-muted-foreground">
                by {artwork.artist?.name || artwork.artist?.specialty || "Unknown Artist"}
              </p>
            </div>
