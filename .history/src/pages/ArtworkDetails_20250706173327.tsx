...
// TODO: After updating your database schema to use 'image_path' column, update the select queries below:
// Replace the current column name with 'image_path' in both select queries
// Example:
// .select(`
//   id,
//   title,
...
//   description,
//   category,
//   image_path,  // Use this instead of the full URL
//   slug,
