    ...
    try {
      ...
      if (orderError) {
        ...
        if (orderData && typeof orderData === 'object') {
          const errorData = orderData as { error?: string; details?: Record<string, unknown> };
          if (errorData.error) {
        ...
        // If error has context or message, use that
        if (orderError && typeof orderError === 'object') {
          const err = orderError as { message?: string; context?: { msg?: string } };
          if (err.context?.msg) {
            errorMessage = err.context.msg;
          } else if (err.message && !orderData) {
