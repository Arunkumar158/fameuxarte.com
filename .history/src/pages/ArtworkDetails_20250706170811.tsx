...
interface ArtworkData {
  ...
  image_path?: string | null; // Optional for transition period
  "https://oqslvwynlppuacdrhlxl.supabase.co/storage/v1/object/sign"?: string | null; // Current field
  slug: string | null;
  artist: {
...
const ArtworkDetails = () => {
  ...
  useEffect(() => {
    const generateSignedUrl = async () => {
      // Use image_path if available, otherwise fall back to the current field
      const imagePath = artwork?.image_path || artwork?.["https://oqslvwynlppuacdrhlxl.supabase.co/storage/v1/object/sign"];
    ...
    generateSignedUrl();
  }, [artwork?.image_path, artwork?.["https://oqslvwynlppuacdrhlxl.supabase.co/storage/v1/object/sign"]]);
